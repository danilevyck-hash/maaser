...
type Props = {
  isOpen: boolean;
  onClose: () => void;
  onSave: (cliente: Partial<CxcCliente>) => void;
  onDelete?: (id: number) => void;
  editingCliente: CxcCliente | null;
  saving?: boolean;
};

export default function ClienteModal({ isOpen, onClose, onSave, onDelete, editingCliente, saving }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingCliente) cliente.id = editingCliente.id;
    onSave(cliente);
  };
  ...
  return createPortal(
    ...
    >
      ...
      {confirmDelete && editingCliente && onDelete && (
        <div
