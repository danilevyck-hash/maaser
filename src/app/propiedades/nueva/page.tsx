    ...
    >
      ...
      <div className="bg-white border-b border-gray-200 px-5 py-4 shrink-0">
        <div className="flex items-center gap-3 max-w-[430px] mx-auto">
          ...
          <h1 className="text-base font-semibold text-gray-900">Nueva propiedad</h1>
        </div>
      </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                >
